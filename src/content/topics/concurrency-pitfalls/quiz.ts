...
const quiz: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "Using too few queues",
      "Calling async instead of sync",
  ...
  },
  {
    ...
    options: [
      ...
      "Thread explosion — it spawns more threads",
      "A deadlock that can't be resolved",
      "A memory leak",
    ],
    answer: 0,
    difficulty: "senior",
...
func transfer(_ n: Int) {
    ...
    options: [
      ...
      "Yes — atomic accesses make it fully safe",
      "Yes — the if statement locks automatically",
      "No — because Int isn't Sendable",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "It never uses threads",
      "It creates a new thread per task, but faster",
      "It runs everything on the main actor",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
