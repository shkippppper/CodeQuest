...
const quiz: Question[] = [
  {
    ...
    options: [
      ...
      "A way to make a property lazy",
      "A protocol for equality",
      "A closure stored in a property",
    ],
    answer: 0,
    explanation:
...
p.health = 250`,
  ...
  },
  {
    ...
    options: [
      ...
      "SwiftUI adds a special compiler rule for count",
      "Because count is an Int",
      "It doesn't — $count is the value",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Clamped isn't a real wrapper",
      "Extensions ban all wrappers by name",
      "It works fine",
    ],
    answer: 0,
    difficulty: "senior",
  ...
  },
  {
    ...
    options: [
      ...
      "A wrapper with both wrappedValue and projectedValue",
      "A generic property wrapper",
      "A wrapper used in a struct",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
