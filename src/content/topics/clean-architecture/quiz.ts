...
const quiz: Question[] = [
  {
    ...
    options: [
      ...
      "Every layer can depend on every other layer",
      "The UI layer is at the center",
  ...
  },
  {
    ...
    options: ["Entities (enterprise business rules)", "URLSession", "The View", "Core Data"],
    answer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "At the center with the entities",
      "In the use cases",
...
final class CoreDataUserRepository: UserRepository { /* ... */ }`,
    options: [
      ...
      "Both live in the outer data layer",
      "Both live in the domain layer",
      "The protocol lives in the UI layer",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "It makes business logic untestable",
      "It couples you to a single framework",
      "It has no downsides",
    ],
    answer: 0,
    difficulty: "senior",
  ...
  },
  {
    ...
    options: [
      ...
      "Clean Architecture forbids persistence",
      "SwiftData is API-identical to Core Data",
      "The entities are stored in the cloud",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
