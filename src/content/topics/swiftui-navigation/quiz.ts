...
const quiz: Question[] = [
  {
    ...
    options: [
      ...
      "A concrete destination view instance",
      "A UIViewController",
      "A URL string",
    ],
    answer: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "Immediately navigates to the Item screen",
...
path.removeAll()`,
    options: [
      ...
      "Pushes three new screens",
      "Removes only the last screen",
      "Has no effect",
    ],
    answer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Presents a sheet only once at launch",
      "Requires a separate boolean flag",
      "Presents an alert instead",
    ],
    answer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "You must manually push each view controller",
      "Deep linking isn't possible with NavigationStack",
      "You register URLs with the OS at build time",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "It makes navigation animations faster",
      "It removes the need for a NavigationStack",
  ...
  },
  {
    ...
    options: [
      ...
      "It couldn't show a back button",
