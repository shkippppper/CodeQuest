...
const quiz: Question[] = [
  {
    ...
    options: [
      ...
      "Notify many observers when a subject changes",
    ],
    answer: 0,
    explanation:
...
print(document.text)`,
  ...
  },
  {
    ...
    options: [
      ...
      "To save memory, for no correctness reason",
      "Because Swift arrays can't hold more than one Command",
      "It doesn't need to be cleared — that's a common misconception",
    ],
    answer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Faster execution of the underlying operation",
      "Automatic thread safety with no extra code",
      "Elimination of the need for any receiver object",
    ],
    answer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Operation has nothing in common with the command pattern",
      "Operation cannot be queued, unlike Command",
      "Operation always runs synchronously, unlike Command",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Command classes are always slower than closures at runtime",
      "Command cannot be used with SwiftUI buttons at all",
      "There is no valid objection; this is always a good idea",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
