...
const quiz: Question[] = [
  {
    ...
    options: [
      ...
      "A simulator-only debugging mode",
      "A cache the OS clears every launch",
      "A shared folder every app can read",
    ],
    answer: 0,
    explanation:
...
try fm.createDirectory(at: target, withIntermediateDirectories: false)`,
    options: [
      ...
      "It silently creates both folders",
      "It creates `2024` and ignores `Photos`",
  ...
  },
  {
    ...
    options: [
      ...
      "It makes the write happen on a background thread",
      "It encrypts the file",
      "It guarantees the file is backed up to iCloud",
    ],
    answer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "atomically: true alone is sufficient",
      "FileProtectionType.complete",
      "A DispatchQueue.sync inside just your app",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "complete — always unreadable while locked",
      "none — no protection is applied by default",
      "completeUnlessOpen — the default for background downloads",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
