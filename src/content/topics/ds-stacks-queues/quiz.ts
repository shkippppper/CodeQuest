...
const quiz: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "O(1), same as removing from the end",
      "O(log n)",
...
print(q.dequeue() ?? -1)`,
  ...
  },
  {
    ...
    options: [
      ...
      "The while loop never actually runs more than once total",
      "Swift optimizes nested loops automatically",
      "It actually is O(n^2), but that's acceptable for this problem size",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "A queue — calls resolve in the order they started",
      "A hash table keyed by function name",
      "A linked list traversed backward on each return",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
