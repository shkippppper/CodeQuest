...
const quiz: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "A non-optional guaranteed to exist",
...
b()`,
  ...
  },
  {
    ...
    options: [
      ...
      "Yes — always use [weak self] when self appears",
      "Yes — map stores the closure",
  ...
  },
  {
    ...
    options: [
      ...
      "It's faster to type only",
      "It makes self unowned",
      "It captures self by value",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "No — properties are captured independently of self",
      "It captures a copy of property",
      "It captures self strongly regardless",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
