...
const quiz: Question[] = [
  {
    ...
    options: [
      ...
      "Because `let` isn't allowed inside structs",
...
c.x = 7`,
  ...
  },
  {
    ...
    options: [
      ...
      "They always trigger on every assignment",
    ],
    answer: 0,
    explanation:
...
print(Counter.total)`,
  ...
  },
  {
    ...
    options: [
      ...
      "`lazy` can never be accessed from a background thread",
      "`lazy` recomputes on every access",
...
m.items[0] = 9`,
  ...
  },
  {
    ...
    options: [
      ...
      "`lazy` — it's always cheaper",
      "Either behaves identically",
      "Neither can depend on other properties",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
