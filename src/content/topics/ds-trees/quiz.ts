...
inorder(root) { print($0) }`,
  ...
  },
  {
    ...
    options: [
      ...
      "BSTs cache all previous search results",
      "BST nodes are stored in a sorted array underneath",
      "It's actually O(n); O(log n) is a common misconception",
    ],
    answer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Just remove the node and leave both children disconnected",
      "Always promote the left child to take the node's place, ignoring the right subtree",
  ...
  },
  {
    ...
    options: [
      ...
      "It guarantees O(1) search regardless of tree size",
      "It eliminates the need for a comparison operator on stored values",
      "It automatically sorts data faster than any other structure",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
