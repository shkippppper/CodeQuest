...
const quiz: Question[] = [
  {
    ...
    options: [
      ...
      "Adjacency lists give O(1) edge-existence checks, which matrices can't",
      "Adjacency matrices can't represent directed graphs",
      "Adjacency lists are always faster for every operation",
    ],
    answer: 0,
    explanation:
...
bfs(adjacency, start: "A")`,
  ...
  },
  {
    ...
    options: [
      ...
      "BFS always tries the shortest-looking edge first",
      "It doesn't -- DFS is needed for shortest path",
      "BFS sorts all paths by length before returning",
    ],
    answer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Dijkstra crashes on negative weights, it doesn't silently give wrong answers",
      "Dijkstra doesn't support weighted graphs at all",
      "Negative weights make the graph automatically have a cycle",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Directed graphs can never have cycles",
      "The parent-exclusion trick works identically for directed graphs, no changes needed",
      "Directed graphs don't support DFS",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
