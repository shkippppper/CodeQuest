...
const quiz: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "Only for classes",
      "Only when you write CodingKeys by hand",
      "Never — you always implement it",
    ],
    answer: 0,
    explanation:
...
let model = try decoder.decode(Model.self, from: data)  // fails on the date`,
    options: [
      ...
      "Dates can't be Codable",
      "Add a CodingKeys enum",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "There's no way to know — just retry",
      "Read the raw bytes manually",
      "Use `try?` and ignore it",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Decode everything as [Any]",
      "It's impossible with Codable",
      "Use decodeIfPresent for each field",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
