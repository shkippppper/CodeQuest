...
const quiz: Question[] = [
  {
    ...
    options: [
      ...
      "Data source handles taps; delegate provides cells",
      "They're the same protocol",
      "Delegate stores the model; data source renders",
    ],
    answer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "It renders all cells once and caches images",
      "It limits lists to 100 rows",
      "It creates cells on a background thread",
    ],
    answer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Table views cache images globally",
      "It's a UIKit bug",
  ...
  },
  {
    ...
    options: [
      ...
      "Only call reloadData without touching the model",
      "Only remove from the model; the table auto-updates",
      "Nothing — deletion is automatic",
    ],
    answer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Nothing — async loads always target the right cell",
      "The app crashes; use synchronous loads",
      "Reuse must be disabled for images",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "It runs on a background thread and blocks I/O",
      "It only runs once, so cost doesn't matter",
      "It controls the app's memory limit",
    ],
    answer: 0,
    difficulty: "senior",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      "Extra cells added for padding",
      "Background threads for rendering",
      "The reuse pool",
    ],
    answer: 0,
    difficulty: "senior",
