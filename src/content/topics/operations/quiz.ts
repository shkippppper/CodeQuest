...
const quiz: Question[] = [
  {
    ...
    options: [
      ...
      "Faster execution by bypassing the GCD scheduler and submitting work directly to the underlying thread pool",
  ...
  },
  {
    ...
    options: [
      ...
      "Immediately kills the operation's thread and releases all resources it was holding",
...
queue.addOperations([op1, op2], waitUntilFinished: false)`,
    options: [
      ...
      "No — cancelling op1 permanently blocks op2 because the dependency never reaches its finished state",
  ...
  },
  {
    ...
    options: [
      ...
      "Use a BlockOperation — its closure automatically suspends execution until the async callback fires before marking the operation finished",
...
queue.addOperations([a, b], waitUntilFinished: false)`,
  ...
  },
  {
    ...
    options: [
      ...
      "Operations can't run on background threads because OperationQueue always dispatches all work back to the main queue automatically",
